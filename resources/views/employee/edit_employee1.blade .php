                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);"><a  class="btn btn-sm btn-warning" href="{{ route('all.employee') }}">Go Back</a></li>
...
<div class="col-md-6">
    <div class="mb-3">
        ...
        <input type="date" value="{{$employee-> dob }}" name="doj" class="form-control @error('doj') is-invalid @enderror" >
        @error('doj')
        <span class="text-danger"> {{ $message }} </span>
        @enderror
    </div>
...
<div class="col-md-6">
    ...
    <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror"  value="{{ $employee->designation }}"   >
    @error('designation')
    <span class="text-danger"> {{ $message }} </span>
    @enderror
    </div>
...
<div class="col-md-6">
<div class="mb-3">
<label for="gender" class="form-label">Employee Experience    </label>
...
<div class="col-md-1">
    ...
    <img id="showImage" src="{{  asset("upload/employee/".$employee->image) }}" class="rounded- circle avatar-lg img-thumbnail"
    alt="profile-image">
    </div>
    </div> <!-- end col -->
