        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a class="btn btn-sm text-bold btn-warning" href="{{ route('all.designation') }}">Back </a></li>
               ...
               Update Designation
                ...
                <div class="card-body">
                 ...
                 <div class="mb-3">
                        ...
                        <input type="text" placeholder="Enter New Designation Name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $designation->name }}">
                        @error('name')
                        <span class="text-danger"> {{ $message }} </span>
                        @enderror
        
                 </div>
                 <button type="submit" class="btn btn-primary form-control">Update Designation</button>
        ...
        <div class="col-9">
            ...
            <div class="card">
                <div class="card-header bg-info d-flex justify-content-between">
                    <span>List Designations</span>
                    <a href="{{ route('all.designation') }}" class="btn btn-warning btn-sm text-bold">
