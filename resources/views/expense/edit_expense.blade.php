                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="expense_title" class="form-control @error('title') is-invalid @enderror"  name="title" placeholder="Enter Title .." value="{{ $Expense->title }}">
                                    @error('title')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 mt-2">
                                ...
                                <textarea class="ckeditor form-control @error('details') is-invalid @enderror"  cols="3"  name="details" value="{{ old('details') }}"  >{{ $Expense->details }}</textarea>
                                @error('details')
                                <span class="text-danger"> {{ $message }} </span>
                                @enderror
                            </div>
