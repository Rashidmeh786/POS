             ...
             <div class="page-title-box">
                 <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                         <a href="{{ route('employee.attendance.list') }}" class="btn btn-blue btn-lg rounded-pill waves-effect waves-light"><span class="fas fa-arrow-left"></span></a>
                     </ol>
                 </div>
                  ...
                  <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                     ...
                     <div class="row">
                        <div class="form-group col-lg-4">
                           <label for="attendance_datetime" class="control-label">Attendance Date and Time</label>
                           <input type="datetime-local" name="attendance_datetime" id="attendance_datetime" class="form-control mb-2" placeholder="Attendance Date and Time" autocomplete="off">
                       </div>
                       ...
                       <script>
                           ...
                           // Format the date and time as required by the datetime-local input field
                           var formattedDateTime = year + '-' + month + '-' + day + 'T' + hours + ':' + minutes;
                       
                           // Set the value of the input field to the current date and time
                           document.getElementById('attendance_datetime').value = formattedDateTime;
                       </script>
                     ...
                     <table class="table table-hover table-striped dt-responsive" style="width: 100%">
                        <thead>
                           <tr>
                              ...
                              <th rowspan="2" class="text-center text-white bg-secondary" style="width: 200px">Checkin Time</th>

                              <th colspan="3" class="text-center text-white bg-secondary" style="vertical-align: middle">Attendance Status</th>
                           </tr>
                           <tr>
                              <th class="text-center btn present_all bg-dark text-white" style="display: table-cell;background-color:#114190">Present</th>
                              <th class="text-center btn leave_all bg-dark text-white" style="display: table-cell;background-color:#114190">Leave</th>
                              <th class="text-center btn absent_all bg-dark text-white" style="display: table-cell;background-color:#114190">Absent</th>
                           </tr>
                        </thead>
                        <tbody>
                           ...
                           <tr id="div{{$employee->id}}" class="text-center">
                              ...
                              <td>{{$key+1}}</td>
                              <td>{{$employee->name}}</td>
                              <td><input type="time" name="checkin_time{{ $key }}" class="form-control mb-2" placeholder="Attendance Time" autocomplete="off">
                              </td>
                              <td colspan="3">
                     ...
                     <button type="submit" class="btn btn-success btn-sm p-2">Submit Attendance</button>
                  </form>
               </div>
               <!-- end card body-->
            </div>
