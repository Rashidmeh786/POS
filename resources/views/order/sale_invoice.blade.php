 ...
 <div class="content">
    ...
    <div class="card">
      ...
      @endphp
              ...
              <div class="row">
                <div class="col-xl-8">
                  <ul class="list-unstyled">
                    <li class="text-bold">To: <span style="color:#041824 ; font-weight: bold">{{ $customer->name  ?? 'Opening balance' }}</span></li>
                    <li class="text-muted "> <i class="fas fa-address-book"></i>  {{ $customer->address  ?? 'NA'}} , {{ $customer->city }},</li>
              ...
              <form class="px-3" method="post" id="payment-form" action="{{ url('/final-invoice/sale') }}">
