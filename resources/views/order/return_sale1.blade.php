            ...
            <div class="offset-md-8 col-md-4">
              ...
              <table class="table table-striped mt-2">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>order Tax</td> 
                    <td id="taxvalue">{{ $order->vat  ?? 0}}</td> 
                  

                  </tr>
                  <tr>
                    <td>Discount</td> 
                    <td id="discountvalue">{{ $order->discount  ?? 0 }}</td> 
                 
                  </tr>
                  <tr>
                    <td>Shipping</td> 
                    <td id="shippingvalue">{{ $order->shipping  ?? 0 }}</td> 
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="tax" name="text"  value="{{ $order->vat ?? 0}}" placeholder="Enter tax amount">
              ...
              <div class="col-md-4">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="discount" value="{{ $order->discount   ?? 0 }}" name="discount" placeholder="Enter discount">
                  <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                </div>
              </div>
              ...
              <div class="col-md-4">
                ...
                <div class="input-group">
                  <input type="text"  class="form-control" id="shippingcharges"  value="{{ $order->shipping  ?? 0 }}"  name="shipping" placeholder="Enter shipping charges">
                  <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                </div>
              </div>
