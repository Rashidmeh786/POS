                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <input type="text" min="1" value="1" name="quantity" class="form-control quantity-input" placeholder="Qty" style="width: 59px; height: 44px; "> {{--   style="width: 59px; height: 44px; "--}}
