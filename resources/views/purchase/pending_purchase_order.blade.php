 ...
 <div class="content">
    ...
    <div class="row">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $key+1 }}</td>
                <td>   <img style="height: 40px; width: 40px" src="{{ (!empty($item->supplier->image)) ? url('upload/supplier/'.$item->supplier->image) : url('upload/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail">
                </td>
