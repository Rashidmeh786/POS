                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a class="btn btn-info" href="{{ route('all.customer') }}"><span class="fas fa-arrow-left"></span></a></li>
                                                <form method="post" action="{{ route('customer.store') }}" enctype="multipart/form-data">

                                                <li class="breadcrumb-item"><button  type="submit" class="btn btn-primary ">Save </button></li>
